...
export default function Footer() {
  ...
  if (!ready) return <div className="text-center text-white">Loading...</div>; // Prevent rendering mismatched content
        ...
        <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <address className="space-y-1 text-sm text-white not-italic">
                <div suppressHydrationWarning>
                  {t("footer.phone", "Phone")}: +82 10-1234-5678
                </div>
                <div>
                ...
                <div suppressHydrationWarning>
                  {t("footer.address", "123 Main St, Seoul, South Korea")}
                </div>
              </address>
            </div>
          ...
          <div className="mt-6 border-t border-[#666] text-center text-white">
            <p className="text-sm" suppressHydrationWarning>
              &copy; 2025 Zeta English Academy. {t("footer.rightsReserved", "All rights reserved.")}
            </p>
          </div>
        </div>
      </footer>
